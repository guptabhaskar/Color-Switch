...
public class GameLoadedController implements Initializable {
    GameState gameState=new GameState();
    GameState gameStateD=new GameState();
    ...
    public void DeSerialize() throws  Exception{
        ...
        gameStateD=(GameState)objectInputStream.readObject();
    ...
    public void goToScorePage() throws Exception {
        ...
        System.out.println(gameStateD.getBallPos());
        gameState.setBallColor(String.valueOf(MainBall.getC().getFill()));
        gameState.setBallPos(MainBall.getC().getTranslateY());
        gameState.setHighestScore(Integer.parseInt(ScoreL.getText()));
//        gameState.setObstacle(ObstaclesOnScreen);
        Serialize();
        DeSerialize();
        System.out.println(gameStateD.getBallPos());

        System.out.println(gameStateD.getBallColor());
    }
